...
public class ConnectionFactory {
	...
	public Connection getConnection() {
		...
		try {
			...
			prop.load(new FileReader("C:/Users/laure/my_git_repos/1708Aug14Code/Lauren_Wallace_Code/ResortApplication/ResortPersonelPortal/src/main/java/com/resort/util/database.properties"));
