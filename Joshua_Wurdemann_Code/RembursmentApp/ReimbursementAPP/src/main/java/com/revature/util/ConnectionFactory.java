...
public class ConnectionFactory {
	...
	public Connection getConnection(){
		...
		try{
			...
			prop.load(new FileReader("C:/Users/joshw/my_git_repos/1708Aug14Code/Joshua_Wurdemann_Code/RembursmentApp/ReimbursementAPP/src/main/java/com/revature/util/Databaseproperties"));
