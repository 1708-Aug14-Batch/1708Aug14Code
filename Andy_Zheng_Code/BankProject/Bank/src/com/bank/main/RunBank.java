...
public class RunBank {
	...
	public static void main(String[] args) {
		...
		//dao.addUser("Andy", "Zheng", "AndyZheng@gmail.com","password");
		
		User u = new User(1,"Andy", "Zheng","Andy@gmail.com","password");
		
		dao.updateUser(u);
		
		//dao.addAccount(1, 2);
		
		//System.out.println(dao.getUser("AndyZheng@gmail.com", "password").toString());
	}
