...
CREATE OR REPLACE PROCEDURE getUserInfo(inUSERID IN NUMBER, outFN OUT VARCHAR2, outLN OUT VARCHAR2, outEMAIL OUT VARCHAR2, outPASSWORD OUT VARCHAR2, outISM OUT NUMBER)
AS
BEGIN
    SELECT FIRSTNAME, LASTNAME, EMAIL, PASSWORD, ISMANAGER
    INTO outFN, outLN, outEMAIL, outPASSWORD, outISM
    FROM USERS
...
UPDATE REIMBURSEMENTS SET RESOLVERID = 207, RESOLVEDATE = CURRENT_TIMESTAMP, STATUSID = 2, NOTES = 'No'
WHERE REIMID = 174;