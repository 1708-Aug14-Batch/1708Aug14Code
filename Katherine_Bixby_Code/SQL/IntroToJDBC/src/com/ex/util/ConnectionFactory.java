package com.ex.util;
//This is going to be Singleton...not factory
...
public class ConnectionFactory {
	...
	public Connection getConnection() {
		...
		try {
			...
			prop.load(new FileReader("C:/Users/Katie/my_git_repos/1708Aug14Code/Katherine_Bixby_Code/SQL/IntroToJDBC/src/com/ex/util/database.properties"));
