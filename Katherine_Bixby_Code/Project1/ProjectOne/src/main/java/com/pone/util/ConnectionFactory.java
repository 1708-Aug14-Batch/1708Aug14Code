...
public class ConnectionFactory {
	...
	public Connection getConnection() {
		...
		try {
			...
			prop.load(new FileReader("C:/Users/Katie/my_git_repos/1708Aug14Code/Katherine_Bixby_Code/Project1/ProjectOne/src/main/java/com/pone/util/database.properties"));
