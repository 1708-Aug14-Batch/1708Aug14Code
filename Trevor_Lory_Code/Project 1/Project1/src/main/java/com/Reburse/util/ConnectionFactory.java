...
public class ConnectionFactory {
	...
	public Connection getConnection() {
		...
		try {
			...
			prop.load(new FileReader("E:/Thingsn'Stuff/RevTrain/Repos/1708Aug14Code/Trevor_Lory_Code/Project 1/Project1/src/main/java/com/Reburse/util/database.properties"));
