...
@WebServlet("/getUserDashInfo")
public class getDashUserInfoServlet extends HttpServlet{
	
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		System.out.println("in Dash info servlet");
		...
		if(sessionUser != null) {
			ArrayList<Reimbursement> rems = ser.getReimByUser(sessionUser);
			int tempP = 0;
			int tempA = 0;
			int tempD = 0;
