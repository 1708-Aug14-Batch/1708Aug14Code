...
public class ConnectionFactory {
	...
	public Connection getConnection()
	{
		...
		try {
			...
			prop.load(new FileReader("C://Users//ChaosDragon//my_git_repos//1708Aug14Code//Joshua_Locklear_Code//WeekOneCoreJava//TestBank//src/com//util//database.properties"));
